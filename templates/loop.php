                ...
                <?php while( have_posts() ): the_post(); ?>
                  <li class="index-post-list__item">
                    ...
                    <div class="index-post-list__info animated" data-animate="fadeInRight">
                      ...
                      <h3 class="index-post-list__title"><a class="index-post-list__link" href="<?php the_permalink( '' ); ?>"><?php echo wp_trim_words( get_the_title(), 60, '...' ); ?></a></h3>
                      <p class="index-post-list__description"><?php echo wp_trim_words( get_the_excerpt(), 120, '...' ); ?></p>
                    </div>
                  </li>
                <?php endwhile; ?>
              </ul>
